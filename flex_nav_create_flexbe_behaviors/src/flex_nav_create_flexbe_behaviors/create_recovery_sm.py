...
'''
class CreateRecoverySM(Behavior):
    '''
    A recovery behavior for the flex nav system with iRobot Create
    '''


    def __init__(self):
        super(CreateRecoverySM, self).__init__()
        self.name = 'Create Recovery'
    ...
    def create(self):
        ...
        with _sm_recovery_steps_0:
            ...
            OperatableStateMachine.add('Backup',
                                        MoveDistanceState(target_time=3, distance=-0.33, cmd_topic='/create_node/cmd_vel', odometry_topic='/create_node/odom'),
